	...
	<div name="sendActivity">
				  <el-form :model="activityRuleForm" :rules="activityRules" ref="activityRuleForm" label-width="120px" class="demo-ruleForm">
				    <el-form-item label="发布类型" prop="type">
				      <el-select v-model="activityRuleForm.type" placeholder="请选择">
					...
					<el-form-item :label="isType+'加分'" prop="score">
				    ...
				    <el-form-item :label="isType+'类型'" prop="belong">
				    ...
				    <el-form-item :label="isType+'报名时间'" required >
				      <el-col :span="11">
					...
					<el-form-item :label="isType+'开始时间'" required>
					  <el-col :span="11">
					...
					<el-form-item :label="isType+'地点'" prop="address">
				    ...
				    <el-form-item :label="isType+'详细'" prop="content">
				      <mavon-editor 
...
<script>
	export default{
		...
		computed:{
			isType(){
				return this.activityRuleForm.type
			}
		},
		methods:{
